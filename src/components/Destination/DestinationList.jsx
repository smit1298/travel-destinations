  ...
  return (
    <div className="mt-4">
      {destinations.length === 0 ? (
        <div className="flex flex-col items-center rounded-lg border-solid border-2 border-gray-100 py-4 mx-auto">
          <svg
